...
var canvas, drawScene, getShader, gl, horizAspect, initBuffers, initShaders, initWebGL, loadIdentity, multMatrix, mvMatrix, mvTranslate, perspectiveMatrix, setMatrixUniforms, shaderProgram, squareVerticesBuffer, start, vertexPositionAttribute;
...
initBuffers = function() {
  ...
  return gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices), gl.STATIC_DRAW);
};
